...
class AppStyles {
  static TextStyle thinStyle({Color? color}) {
    return GoogleFonts.roboto(fontSize: 12.sp, color: color ?? AppColors.primaryColor);
  }
  ...
  static TextStyle mediumStyle({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return GoogleFonts.poppins(fontSize: fontSize ?? 14.sp, fontWeight: fontWeight ?? FontWeight.w500, color: color);
  }

...
abstract class FilterData {
  ...
  Iterable<int>? _selectedCategories;
  ...
  List<int> get selectedMasters => _selectedMasters ?? [];
  Iterable<int> get selectedCategories => _selectedCategories ?? [];
